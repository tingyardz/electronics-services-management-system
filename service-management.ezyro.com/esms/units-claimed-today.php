...
$sql = "SELECT * FROM `units_claimed_today` WHERE `Date` = '$currentDate' ";
            ...
            <div id="layoutSidenav_content">
                ...
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Units Claimed Today</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Units Claimed Today</li>
                        </ol>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['Additional Fees']; ?></td>
